                ...
                <div class="content">
                    <div class="control is-horizontal">
                      ...
                      <div class="control is-fullwidth">
                        <input name="first_name" class="input{{ $errors->has('first_name') ? ' is-danger' : '' }}" type="text" value="{{ old('first_name') }}" required autofocus>
                      </div>
                    </div>
                    ...
                    <div class="control is-horizontal">
                        ...
                        <div class="control is-fullwidth">
                        <input name="last_name" class="input{{ $errors->has('last_name') ? ' is-danger' : '' }}" type="text" value="{{ old('last_name') }}" required>
                        </div>
                    </div>
