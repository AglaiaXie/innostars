<div class="navbar-tabs">
  <a class="navbar-item is-tab{{Request::segment(3) === 'information' ? ' is-active' : ''}}" href="information">
    <span class="tag is-rounded is-info">1</span>&nbsp; Partner Information
    @if($user->partner_profile->submit)
  ...
  @if($user->partner_profile->current_step >= 2)
    <a class="navbar-item is-tab{{Request::segment(3) === 'preference' ? ' is-active' : ''}}" href="preference">
      <span class="tag is-rounded is-info">2</span>&nbsp; Partner Preference
    </a>
  @endif
  ...
  @endif
  @if($user->partner_profile->current_step >= 4)
