...
class InvestorApproved extends Mailable
{
    ...
    public function build()
    {
        return $this->subject('2018 InnoSTARS Application Confirmation')
            ->markdown('vendor.notifications.email', [
                ...
                "introLines" => [
                    "Congratulations! You have been approved to be the investor for the 2018 InnoSTARS Competition. You can access your account by clicking the button below."
                ],
